...
exports.ReferralProgramAffiliate = exports.RewardStatus = exports.ReferralStatus = void 0;
...
__decorate([
    (0, sequelize_typescript_1.ForeignKey)(() => ReferralProgram_1.ReferralProgram),
    (0, sequelize_typescript_1.Column)({ type: sequelize_typescript_1.DataType.STRING, allowNull: false })
], ReferralProgramAffiliate.prototype, "referralId", void 0);
__decorate([
...
__decorate([
    (0, sequelize_typescript_1.BelongsTo)(() => ReferralProgram_1.ReferralProgram)
