...
exports.QuestsResponse = exports.QuestsResponseType = exports.QuestsResponseStatus = void 0;
...
let QuestsResponse = class QuestsResponse extends sequelize_typescript_1.Model {
    mustBeInvitedToQuest(workerId) {
        ...
        if (this.workerId !== workerId) {
            throw (0, utils_1.error)(errors_1.Errors.Forbidden, "User isn't invited to quest", {});
        }
    }
    mustHaveStatus(status) {
        if (this.status !== status) {
            throw (0, utils_1.error)(errors_1.Errors.Forbidden, "Quest response status doesn't match", {
                mustHave: status,
                current: this.status,
            });
        }
    ...
    mustHaveType(type) {
        if (this.type !== type) {
            throw (0, utils_1.error)(errors_1.Errors.Forbidden, "Quest response type doesn't match", {
                mustHave: type,
                current: this.type,
            });
        }
...
__decorate([
    (0, sequelize_typescript_1.Column)({ type: sequelize_typescript_1.DataType.INTEGER, defaultValue: QuestsResponseStatus.Open })
], QuestsResponse.prototype, "status", void 0);
__decorate([
    (0, sequelize_typescript_1.Column)({ type: sequelize_typescript_1.DataType.INTEGER, defaultValue: QuestsResponseType.Response })
