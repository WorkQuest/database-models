...
__decorate([
    sequelize_typescript_1.ForeignKey(() => QuestDispute_1.QuestDispute), sequelize_typescript_1.Column({ type: sequelize_typescript_1.DataType.STRING, allowNull: false })
