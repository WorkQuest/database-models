...
exports.Quest = exports.activeFlowStatuses = void 0;
...
exports.activeFlowStatuses = [
    types_2.QuestStatus.Created,
    types_2.QuestStatus.Active,
    types_2.QuestStatus.Dispute,
    types_2.QuestStatus.WaitWorker,
    types_2.QuestStatus.WaitConfirm,
];
...
__decorate([
    (0, sequelize_typescript_1.Column)({ type: sequelize_typescript_1.DataType.INTEGER, defaultValue: types_2.QuestStatus.Created })
...
__decorate([
    (0, sequelize_typescript_1.Column)({ type: sequelize_typescript_1.DataType.INTEGER, defaultValue: types_2.AdType.Free })
