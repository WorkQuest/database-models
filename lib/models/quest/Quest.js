...
exports.Quest = exports.QuestWorkPlace = exports.QuestStatus = exports.AdType = exports.QuestPriority = void 0;
...
let Quest = class Quest extends sequelize_typescript_1.Model {
    updateFieldLocationPostGIS() {
        this.setDataValue('locationPostGIS', utils_2.transformToGeoPostGIS(this.getDataValue('location')));
    }
