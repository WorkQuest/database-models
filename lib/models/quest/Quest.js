...
exports.Quest = exports.activeFlowStatuses = exports.QuestEmployment = exports.QuestStatus = void 0;
...
__decorate([
    (0, sequelize_typescript_1.HasOne)(() => QuestRaiseView_1.QuestRaiseView)
...
Quest = __decorate([
    (0, sequelize_typescript_1.Scopes)(() => ({
        ...
        short: {
            ...
            include: [{
                    model: User_1.User.scope('shortForList'),
                    as: 'user'
                }, {
                    model: User_1.User.scope('shortForList'),
                    as: 'assignedWorker'
                    ...
                    where: { status: QuestDispute_1.DisputeStatus.Pending },
                }],
        }
    })),
