...
let Quest = class Quest extends sequelize_typescript_1.Model {
    updateFieldLocationPostGIS() {
        this.setDataValue('locationPostGIS', utils_1.transformToGeoPostGIS(this.getDataValue('location')));
    }
...
__decorate([
    sequelize_typescript_1.BelongsToMany(() => SpecializationFilter_1.SpecializationFilter, () => QuestSpecializationFilter_1.QuestSpecializationFilter)
...
__decorate([
    sequelize_typescript_1.HasMany(() => QuestSpecializationFilter_1.QuestSpecializationFilter, { as: 'questSpecializationsFilter' })
], Quest.prototype, "questSpecializationsFilter", void 0);
Quest = __decorate([
