...
__decorate([
    ...
    sequelize_typescript_1.Column({ type: sequelize_typescript_1.DataType.STRING, allowNull: false, references: { model: "Medias", key: "id" } })
], DiscussionCommentMedia.prototype, "mediaId", void 0);
__decorate([
    sequelize_typescript_1.ForeignKey(() => DiscussionComment_1.DiscussionComment),
    sequelize_typescript_1.Column({ type: sequelize_typescript_1.DataType.STRING, allowNull: false, references: { model: "DiscussionComments", key: "id" } })
