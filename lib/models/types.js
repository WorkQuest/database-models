...
(function (NetworkProfileVisibilityType) {
    NetworkProfileVisibilityType["GET"] = "GET";
    NetworkProfileVisibilityType["POST"] = "POST";
    NetworkProfileVisibilityType["PUT"] = "PUT";
    NetworkProfileVisibilityType["DELETE"] = "DELETE";
