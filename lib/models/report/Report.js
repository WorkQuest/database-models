...
exports.Report = exports.reportEntities = exports.ReportEntityType = exports.ReportStatus = void 0;
...
(function (ReportEntityType) {
    ...
    ReportEntityType["DiscussionComment"] = "DiscussionComment";
...
exports.reportEntities = {
    ...
    DiscussionComment: { entity: DiscussionComment_1.DiscussionComment, statuses: DiscussionComment_1.DiscussionCommentStatus }
};
...
__decorate([
    (0, sequelize_typescript_1.Column)({ type: sequelize_typescript_1.DataType.SMALLINT, defaultValue: ReportStatus.Created })
], Report.prototype, "status", void 0);
__decorate([
    (0, sequelize_typescript_1.Column)({ type: sequelize_typescript_1.DataType.INTEGER, autoIncrement: true })
], Report.prototype, "number", void 0);
__decorate([
    (0, sequelize_typescript_1.Column)({ type: sequelize_typescript_1.DataType.STRING, allowNull: false })
...
__decorate([
    (0, sequelize_typescript_1.BelongsToMany)(() => Media_1.Media, () => ReportMedia_1.ReportMedia)
