...
__decorate([
    (0, sequelize_typescript_1.Column)({ type: sequelize_typescript_1.DataType.STRING, primaryKey: true, defaultValue: () => (0, index_1.getUUID)() })
...
__decorate([
    (0, sequelize_typescript_1.ForeignKey)(() => Report_1.Report),
    (0, sequelize_typescript_1.Column)({ type: sequelize_typescript_1.DataType.STRING, allowNull: false })
...
__decorate([
    (0, sequelize_typescript_1.BelongsTo)(() => Report_1.Report)
