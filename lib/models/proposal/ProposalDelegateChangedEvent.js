...
__decorate([
    (0, sequelize_typescript_1.BelongsTo)(() => Wallet_1.Wallet, { foreignKey: 'fromDelegate', targetKey: 'address' })
], ProposalDelegateChangedEvent.prototype, "fromDelegateWallet", void 0);
__decorate([
    (0, sequelize_typescript_1.BelongsTo)(() => Wallet_1.Wallet, { foreignKey: 'toDelegate', targetKey: 'address' })
