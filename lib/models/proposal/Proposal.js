...
], Proposal.prototype, "proposerUserId", void 0);
__decorate([
...
], Proposal.prototype, "discussionId", void 0);
__decorate([
    sequelize_typescript_1.Column({ type: sequelize_typescript_1.DataType.STRING, allowNull: false })
...
__decorate([
    sequelize_typescript_1.Column({ type: sequelize_typescript_1.DataType.INTEGER, defaultValue: types_1.ProposalStatus.Pending })
], Proposal.prototype, "status", void 0);
__decorate([
    sequelize_typescript_1.Column({ unique: true, allowNull: false, type: sequelize_typescript_1.DataType.DECIMAL, defaultValue: () => utils_1.getUUIDInt() })
], Proposal.prototype, "nonce", void 0);
__decorate([
    sequelize_typescript_1.HasOne(() => ProposalCreatedEvent_1.ProposalCreatedEvent)
], Proposal.prototype, "createdEvent", void 0);
__decorate([
    sequelize_typescript_1.HasOne(() => ProposalExecutedEvent_1.ProposalExecutedEvent)
], Proposal.prototype, "executedEvent", void 0);
__decorate([
    sequelize_typescript_1.HasMany(() => ProposalVoteCastEvent_1.ProposalVoteCastEvent)
], Proposal.prototype, "voteCastEvents", void 0);
__decorate([
    sequelize_typescript_1.BelongsTo(() => User_1.User)
], Proposal.prototype, "proposerUser", void 0);
__decorate([
    sequelize_typescript_1.BelongsTo(() => Discussion_1.Discussion)
], Proposal.prototype, "discussion", void 0);
__decorate([
