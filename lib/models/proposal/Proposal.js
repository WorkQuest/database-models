...
const VoteCastEvents_1 = require("./VoteCastEvents");
var ProposalStatus;
(function (ProposalStatus) {
    ProposalStatus[ProposalStatus["null"] = -1] = "null";
    ProposalStatus[ProposalStatus["Pending"] = 0] = "Pending";
    ProposalStatus[ProposalStatus["Rejected"] = 1] = "Rejected";
    ProposalStatus[ProposalStatus["Accepted"] = 2] = "Accepted";
    ProposalStatus[ProposalStatus["Cancelled"] = 3] = "Cancelled";
...
__decorate([
    sequelize_typescript_1.Column({ type: sequelize_typescript_1.DataType.INTEGER, defaultValue: ProposalStatus.null })
...
__decorate([
    sequelize_typescript_1.HasMany(() => VoteCastEvents_1.VoteCastEvents)
], Proposal.prototype, "voting", void 0);
Proposal = __decorate([
