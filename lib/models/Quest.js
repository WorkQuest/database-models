...
__decorate([
    sequelize_typescript_1.BelongsTo(() => Filter_1.Filter, { constraints: false, foreignKey: 'avatarId' })
], Quest.prototype, "filter", void 0);
__decorate([
...
__decorate([
    sequelize_typescript_1.HasMany(() => Filter_1.Filter)
], Quest.prototype, "filters", void 0);
Quest = __decorate([
    sequelize_typescript_1.Scopes(() => ({
        defaultScope: {
            ...
            include: [{
                    ...
                    model: Filter_1.Filter.scope('questFilter'),
                    as: 'filter',
                }]
        }
    })),
