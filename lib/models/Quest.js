...
(function (QuestWorkPlace) {
    QuestWorkPlace[QuestWorkPlace["Distant"] = 0] = "Distant";
    QuestWorkPlace[QuestWorkPlace["Office"] = 1] = "Office";
    QuestWorkPlace[QuestWorkPlace["Both"] = 2] = "Both";
...
__decorate([
    sequelize_typescript_1.Column({ type: sequelize_typescript_1.DataType.INTEGER, defaultValue: QuestWorkPlace.Distant })
