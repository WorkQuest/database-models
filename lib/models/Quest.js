...
exports.Quest = exports.QuestWorkPlacement = exports.QuestStatus = exports.AdType = exports.QuestPriority = void 0;
...
var QuestWorkPlacement;
(function (QuestWorkPlacement) {
    QuestWorkPlacement[QuestWorkPlacement["Distant"] = 0] = "Distant";
    QuestWorkPlacement[QuestWorkPlacement["Office"] = 1] = "Office";
    QuestWorkPlacement[QuestWorkPlacement["Both"] = 2] = "Both";
})(QuestWorkPlacement = exports.QuestWorkPlacement || (exports.QuestWorkPlacement = {}));
...
__decorate([
    sequelize_typescript_1.Column({ type: sequelize_typescript_1.DataType.INTEGER, defaultValue: QuestWorkPlacement.Distant })
], Quest.prototype, "placement", void 0);
__decorate([
...
__decorate([
    sequelize_typescript_1.Column({
        ...
        get() {
            const questSkillFilters = this.getDataValue('questSkillFilters');
            return (questSkillFilters ? SkillFilter_1.SkillFilter.toMapSkills(questSkillFilters) : undefined);
        },
...
], Quest.prototype, "questSkillFilters", void 0);
Quest = __decorate([
