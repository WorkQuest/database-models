...
(function (QuestEmployment) {
    QuestEmployment[QuestEmployment["FullTime"] = 0] = "FullTime";
    QuestEmployment[QuestEmployment["PartTime"] = 1] = "PartTime";
    QuestEmployment[QuestEmployment["FixedTerm"] = 2] = "FixedTerm";
...
__decorate([
    sequelize_typescript_1.Column({ type: sequelize_typescript_1.DataType.INTEGER, defaultValue: QuestEmployment.FullTime })
