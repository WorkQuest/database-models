...
let Chat = Chat_1 = class Chat extends sequelize_typescript_1.Model {
    static chatMustExists(chatId) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!(yield Chat_1.findByPk(chatId))) {
                throw utils_1.error(errors_1.Errors.NotFound, "Chat does not exist", { chatId });
            }
        });
    }
...
], Chat.prototype, "starredChat", void 0);
__decorate([
...
], Chat.prototype, "otherChatMember", void 0);
