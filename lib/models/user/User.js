...
const UserRaiseView_1 = require("./UserRaiseView");
...
const ProfileVisibilitySetting_1 = require("./ProfileVisibilitySetting");
...
__decorate([
    sequelize_typescript_1.Column({ type: sequelize_typescript_1.DataType.JSONB, defaultValue: null })
...
__decorate([
    sequelize_typescript_1.HasMany(() => QuestsResponse_1.QuestsResponse)
], User.prototype, "questsResponses", void 0);
__decorate([
    sequelize_typescript_1.HasMany(() => Quest_1.Quest)
], User.prototype, "quest", void 0);
__decorate([
    sequelize_typescript_1.HasOne(() => ProfileVisibilitySetting_1.ProfileVisibilitySetting)
], User.prototype, "profileVisibilitySetting", void 0);
__decorate([
    sequelize_typescript_1.HasOne(() => RatingStatistic_1.RatingStatistic)
], User.prototype, "ratingStatistic", void 0);
__decorate([
    sequelize_typescript_1.HasOne(() => QuestsStatistic_1.QuestsStatistic)
], User.prototype, "questsStatistic", void 0);
__decorate([
    sequelize_typescript_1.HasOne(() => UserRaiseView_1.UserRaiseView)
...
__decorate([
    sequelize_typescript_1.HasMany(() => QuestsReview_1.QuestsReview, 'toUserId')
...
__decorate([
    sequelize_typescript_1.HasOne(() => Wallet_1.Wallet)
], User.prototype, "wallet", void 0);
__decorate([
    sequelize_typescript_1.HasOne(() => ReferralProgramAffiliate_1.ReferralProgramAffiliate)
], User.prototype, "affiliateUser", void 0);
__decorate([
    sequelize_typescript_1.HasOne(() => ReferralProgramReferral_1.ReferralProgramReferral)
], User.prototype, "referralUser", void 0);
__decorate([
    sequelize_typescript_1.HasOne(() => Chat_1.Chat)
], User.prototype, "chatOfUser", void 0);
__decorate([
    sequelize_typescript_1.HasOne(() => ChatsStatistic_1.ChatsStatistic)
