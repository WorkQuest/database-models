...
(function (RatingStatus) {
    RatingStatus[RatingStatus["verified"] = 0] = "verified";
    RatingStatus[RatingStatus["reliable"] = 1] = "reliable";
    RatingStatus[RatingStatus["topRanked"] = 2] = "topRanked";
...
__decorate([
    (0, sequelize_typescript_1.Column)({ type: sequelize_typescript_1.DataType.INTEGER, defaultValue: RatingStatus.noStatus })
