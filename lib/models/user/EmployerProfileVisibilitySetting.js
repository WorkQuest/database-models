...
exports.EmployerProfileVisibilitySetting = void 0;
...
__decorate([
    (0, sequelize_typescript_1.Column)({ type: sequelize_typescript_1.DataType.ARRAY(sequelize_typescript_1.DataType.INTEGER), defaultValue: [types_1.RatingStatus.AllStatuses] })
], EmployerProfileVisibilitySetting.prototype, "ratingStatusCanRespondOnQuest", void 0);
__decorate([
    (0, sequelize_typescript_1.Column)({ type: sequelize_typescript_1.DataType.ARRAY(sequelize_typescript_1.DataType.INTEGER), defaultValue: [types_1.RatingStatus.AllStatuses] })
