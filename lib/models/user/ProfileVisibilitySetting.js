...
(function (NetworkProfileVisibility) {
    NetworkProfileVisibility[NetworkProfileVisibility["EveryoneOnTheInternet"] = 0] = "EveryoneOnTheInternet";
    NetworkProfileVisibility[NetworkProfileVisibility["RegisteredUsers"] = 1] = "RegisteredUsers";
    NetworkProfileVisibility[NetworkProfileVisibility["SubmittingOffer"] = 2] = "SubmittingOffer";
...
__decorate([
    sequelize_typescript_1.Column({ type: sequelize_typescript_1.DataType.INTEGER, defaultValue: NetworkProfileVisibility.EveryoneOnTheInternet })
], ProfileVisibilitySetting.prototype, "networkProfileVisibility", void 0);
__decorate([
    sequelize_typescript_1.Column({ type: sequelize_typescript_1.DataType.INTEGER, defaultValue: types_1.Priority.AllPriority })
], ProfileVisibilitySetting.prototype, "jobPriorityProfileVisibility", void 0);
__decorate([
