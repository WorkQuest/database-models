...
], StarredMessage.prototype, "memberId", void 0);
__decorate([
    sequelize_typescript_1.ForeignKey(() => Message_1.Message),
    sequelize_typescript_1.Column({ type: sequelize_typescript_1.DataType.STRING, allowNull: false })
], StarredMessage.prototype, "messageId", void 0);
__decorate([
    sequelize_typescript_1.BelongsTo(() => ChatMember_1.ChatMember, { constraints: false })
], StarredMessage.prototype, "member", void 0);
__decorate([
