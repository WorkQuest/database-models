...
exports.Message = exports.SenderMessageStatus = exports.MessageType = void 0;
...
__decorate([
    (0, sequelize_typescript_1.Column)({ type: sequelize_typescript_1.DataType.STRING, defaultValue: SenderMessageStatus.unread })
...
__decorate([
    (0, sequelize_typescript_1.HasOne)(() => InfoMessage_1.InfoMessage)
], Message.prototype, "infoMessage", void 0);
__decorate([
    (0, sequelize_typescript_1.HasOne)(() => StarredMessage_1.StarredMessage)
], Message.prototype, "star", void 0);
__decorate([
    (0, sequelize_typescript_1.BelongsToMany)(() => Media_1.Media, () => MessageMedia_1.MessageMedia)
], Message.prototype, "medias", void 0);
__decorate([
    (0, sequelize_typescript_1.BelongsTo)(() => ChatMember_1.ChatMember, 'senderMemberId')
...
Message = __decorate([
    (0, sequelize_typescript_1.Scopes)(() => ({
        ...
        forChatData: {
            ...
            include: [{
                    model: ChatMember_1.ChatMember.scope('forChatData'),
                    as: 'sender',
                }],
        }
    })),
