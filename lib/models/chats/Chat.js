...
Chat = __decorate([
    sequelize_typescript_1.Scopes(() => ({
        chatsList: {
            ...
            include: [{
                    model: GroupChat_1.GroupChat.scope('forChatsList'),
                    as: 'groupChat',
                }, {
                    model: QuestChat_1.QuestChat.scope('forChatsList'),
                    as: 'questChat',
                }, {
                    model: ChatData_1.ChatData.scope('forChatsList'),
                    as: 'chatData',
                }],
        },
        groupChat: {
            ...
            include: [{
                    model: GroupChat_1.GroupChat.scope('forChat'),
                    as: 'groupChat',
                }, {
                    model: ChatData_1.ChatData.scope('forChat'),
                    as: 'chatData',
                }],
        },
        questChat: {
            ...
            include: [{
                    model: QuestChat_1.QuestChat.scope('forChat'),
                    as: 'questChat',
                }, {
                    model: ChatData_1.ChatData.scope('forChat'),
                    as: 'chatData',
