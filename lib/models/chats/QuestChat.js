...
exports.QuestChat = exports.QuestChatStatuses = void 0;
...
], QuestChat.prototype, "employerMemberId", void 0);
__decorate([
    (0, sequelize_typescript_1.ForeignKey)(() => ChatMember_1.ChatMember),
    (0, sequelize_typescript_1.Column)({ type: sequelize_typescript_1.DataType.STRING, allowNull: false })
], QuestChat.prototype, "workerMemberId", void 0);
__decorate([
    (0, sequelize_typescript_1.ForeignKey)(() => ChatMember_1.ChatMember),
    (0, sequelize_typescript_1.Column)(sequelize_typescript_1.DataType.STRING)
], QuestChat.prototype, "adminMemberId", void 0);
__decorate([
    (0, sequelize_typescript_1.ForeignKey)(() => Quest_1.Quest),
    (0, sequelize_typescript_1.Column)({ type: sequelize_typescript_1.DataType.STRING, allowNull: false })
], QuestChat.prototype, "questId", void 0);
__decorate([
    (0, sequelize_typescript_1.ForeignKey)(() => QuestsResponse_1.QuestsResponse),
    (0, sequelize_typescript_1.Column)({ type: sequelize_typescript_1.DataType.STRING, allowNull: false })
...
__decorate([
    (0, sequelize_typescript_1.Column)({ type: sequelize_typescript_1.DataType.INTEGER, defaultValue: QuestChatStatuses.Open })
...
__decorate([
    (0, sequelize_typescript_1.BelongsTo)(() => QuestsResponse_1.QuestsResponse)
], QuestChat.prototype, "response", void 0);
__decorate([
    (0, sequelize_typescript_1.BelongsTo)(() => ChatMember_1.ChatMember, 'workerMemberId')
], QuestChat.prototype, "worker", void 0);
__decorate([
    (0, sequelize_typescript_1.BelongsTo)(() => ChatMember_1.ChatMember, 'employerMemberId')
], QuestChat.prototype, "employer", void 0);
__decorate([
    (0, sequelize_typescript_1.BelongsTo)(() => ChatMember_1.ChatMember, 'adminMemberId')
], QuestChat.prototype, "admin", void 0);
QuestChat = __decorate([
    (0, sequelize_typescript_1.Scopes)(() => ({
        defaultScope: {
            ...
            include: [{
                    model: Quest_1.Quest.scope('short'),
                    as: 'quest',
                }],
        },
        idsOnly: {
