...
__decorate([
    ...
    sequelize_typescript_1.Column({ type: sequelize_typescript_1.DataType.STRING, allowNull: false, references: { model: "Quests", key: "id" } })
], QuestChat.prototype, "questId", void 0);
__decorate([
    sequelize_typescript_1.ForeignKey(() => QuestsResponse_1.QuestsResponse),
    sequelize_typescript_1.Column({ type: sequelize_typescript_1.DataType.STRING, allowNull: false, references: { model: "QuestsResponses", key: "id" } })
], QuestChat.prototype, "responseId", void 0);
__decorate([
    sequelize_typescript_1.ForeignKey(() => Chat_1.Chat),
    sequelize_typescript_1.Column({ type: sequelize_typescript_1.DataType.STRING, allowNull: false, references: { model: "Chats", key: "id" } })
], QuestChat.prototype, "chatId", void 0);
__decorate([
    sequelize_typescript_1.Column({ type: sequelize_typescript_1.DataType.INTEGER, defaultValue: QuestChatStatuses.Open })
