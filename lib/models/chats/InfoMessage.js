...
(function (MessageAction) {
    ...
    MessageAction["groupChatAddUser"] = "groupChatAddUser";
    MessageAction["groupChatDeleteUser"] = "groupChatDeleteUser";
    MessageAction["groupChatLeaveUser"] = "groupChatLeaveUser";
...
__decorate([
    ...
    sequelize_typescript_1.Column({ type: sequelize_typescript_1.DataType.STRING, allowNull: false, references: { model: "Messages", key: "id" } })
], InfoMessage.prototype, "messageId", void 0);
__decorate([
    sequelize_typescript_1.ForeignKey(() => User_1.User),
    sequelize_typescript_1.Column({ type: sequelize_typescript_1.DataType.STRING, defaultValue: null, references: { model: "Users", key: "id" } })
], InfoMessage.prototype, "userId", void 0);
__decorate([
    sequelize_typescript_1.Column({ type: sequelize_typescript_1.DataType.STRING, allowNull: false })
], InfoMessage.prototype, "messageAction", void 0);
__decorate([
    sequelize_typescript_1.BelongsTo(() => User_1.User)
], InfoMessage.prototype, "user", void 0);
__decorate([
