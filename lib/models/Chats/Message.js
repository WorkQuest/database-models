...
(function (SenderMessageStatus) {
    SenderMessageStatus[SenderMessageStatus["unread"] = 0] = "unread";
    SenderMessageStatus[SenderMessageStatus["read"] = 1] = "read";
...
__decorate([
    sequelize_typescript_1.Column({ type: sequelize_typescript_1.DataType.INTEGER, defaultValue: SenderMessageStatus.unread })
