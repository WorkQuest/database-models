...
__decorate([
    sequelize_typescript_1.ForeignKey(() => AdminMessage_1.AdminMessage),
    sequelize_typescript_1.Column({ type: sequelize_typescript_1.DataType.STRING, allowNull: false })
], MessageMedia.prototype, "adminMessageId", void 0);
__decorate([
...
__decorate([
    sequelize_typescript_1.BelongsTo(() => AdminMessage_1.AdminMessage)
], MessageMedia.prototype, "adminMessage", void 0);
