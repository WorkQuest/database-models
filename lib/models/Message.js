...
let Message = Message_1 = class Message extends sequelize_typescript_1.Model {
    static messageMustExists(messageId) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!(yield Message_1.findByPk(messageId))) {
                throw utils_1.error(errors_1.Errors.NotFound, "Message does not exist", { messageId });
            }
        });
    }
    mustBeSender(userId) {
...
__decorate([
    sequelize_typescript_1.HasMany(() => StarredMessage_1.StarredMessage)
], Message.prototype, "starredMessages", void 0);
