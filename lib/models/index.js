...
const ReferralProgram_1 = require("./referralProgram/ReferralProgram");
const ReferrerAffiliateUser_1 = require("./referralProgram/ReferrerAffiliateUser");
const ReferralEventRewardClaimed_1 = require("./referralProgram/ReferralEventRewardClaimed");
const ReferralEventPaidReferral_1 = require("./referralProgram/ReferralEventPaidReferral");
const ReferralEventRegisteredAffiliate_1 = require("./referralProgram/ReferralEventRegisteredAffiliate");
const ReferralParseBlock_1 = require("./referralProgram/ReferralParseBlock");
    ...
    return __awaiter(this, void 0, void 0, function* () {
        const sequelize = new sequelize_typescript_1.Sequelize(dbLink, {
            ...
            models: [
                ...
                ReferrerAffiliateUser_1.ReferrerAffiliateUser,
...
__export(require("./referralProgram/ReferralProgram"));
__export(require("./referralProgram/ReferrerAffiliateUser"));
__export(require("./referralProgram/ReferralParseBlock"));
__export(require("./referralProgram/ReferralEventRewardClaimed"));
__export(require("./referralProgram/ReferralEventPaidReferral"));
__export(require("./referralProgram/ReferralEventRegisteredAffiliate"));
