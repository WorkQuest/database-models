    ...
    return __awaiter(this, void 0, void 0, function* () {
        const sequelize = new sequelize_typescript_1.Sequelize(dbLink, {
            ...
            models: [
                ...
                Comment_1.Comment,
                CommentLike_1.LikeComment,
                CommentMedia_1.CommentMedia,
                News_1.News,
                NewsLike_1.LikeNews,
                NewsMedia_1.NewsMedia
            ]
        });
        if (sync)
...
__export(require("./CommentLike"));
__export(require("./CommentMedia"));
__export(require("./News"));
__export(require("./NewsLike"));
__export(require("./NewsMedia"));
