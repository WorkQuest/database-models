...
const ClaimedEvent_1 = require("./pensionFund/ClaimedEvent");
const ReceivedEvent_1 = require("./pensionFund/ReceivedEvent");
const WithdrewEvent_1 = require("./pensionFund/WithdrewEvent");
    ...
    return __awaiter(this, void 0, void 0, function* () {
        const sequelize = new sequelize_typescript_1.Sequelize(dbLink, {
            ...
            models: [
                ...
                ClaimedEvent_1.ClaimedEvent,
                ReceivedEvent_1.ReceivedEvent,
                WithdrewEvent_1.WithdrewEvent,
            ]
        });
        if (sync)
...
__export(require("./pensionFund/ClaimedEvent"));
__export(require("./pensionFund/ReceivedEvent"));
__export(require("./pensionFund/WithdrewEvent"));
