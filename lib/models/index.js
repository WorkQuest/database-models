...
const ReferralProgram_1 = require("./referral-program/ReferralProgram");
const ReferralProgramAffiliate_1 = require("./referral-program/ReferralProgramAffiliate");
const ReferralEventRewardClaimed_1 = require("./referral-program/ReferralEventRewardClaimed");
const ReferralEventPaidReferral_1 = require("./referral-program/ReferralEventPaidReferral");
const ReferralEventRegisteredAffiliate_1 = require("./referral-program/ReferralEventRegisteredAffiliate");
const ReferralParseBlock_1 = require("./referral-program/ReferralParseBlock");
...
const UserRaiseView_1 = require("./user/UserRaiseView");
    ...
    return __awaiter(this, void 0, void 0, function* () {
        const sequelize = new sequelize_typescript_1.Sequelize(dbLink, {
            ...
            models: [
                ...
                Wallet_1.Wallet,
                ReferralProgram_1.ReferralProgram,
                ReferralProgramAffiliate_1.ReferralProgramAffiliate,
                ReferralParseBlock_1.ReferralParseBlock,
                ReferralEventPaidReferral_1.ReferralEventPaidReferral,
                ReferralEventRewardClaimed_1.ReferralEventRewardClaimed,
                ReferralEventRegisteredAffiliate_1.ReferralEventRegisteredAffiliate,
...
__export(require("./referral-program/ReferralProgram"));
__export(require("./referral-program/ReferralProgramAffiliate"));
__export(require("./referral-program/ReferralParseBlock"));
__export(require("./referral-program/ReferralEventRewardClaimed"));
__export(require("./referral-program/ReferralEventPaidReferral"));
__export(require("./referral-program/ReferralEventRegisteredAffiliate"));
...
__export(require("./user/UserRaiseView"));
