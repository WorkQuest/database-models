...
const Referral_1 = require("./referral/Referral");
const ReferrerAffiliate_1 = require("./referral/ReferrerAffiliate");
const ReferralEventRewardClaimed_1 = require("./referral/ReferralEventRewardClaimed");
const ReferralEventPaidReferral_1 = require("./referral/ReferralEventPaidReferral");
const ReferralEventRegisteredAffiliate_1 = require("./referral/ReferralEventRegisteredAffiliate");
const ReferralParseBlock_1 = require("./referral/ReferralParseBlock");
    ...
    return __awaiter(this, void 0, void 0, function* () {
        const sequelize = new sequelize_typescript_1.Sequelize(dbLink, {
            ...
            models: [
                ...
                Wallet_1.Wallet,
                Referral_1.Referral,
                ReferrerAffiliate_1.ReferrerAffiliate,
...
__export(require("./referral/Referral"));
__export(require("./referral/ReferrerAffiliate"));
__export(require("./referral/ReferralParseBlock"));
__export(require("./referral/ReferralEventRewardClaimed"));
__export(require("./referral/ReferralEventPaidReferral"));
__export(require("./referral/ReferralEventRegisteredAffiliate"));
