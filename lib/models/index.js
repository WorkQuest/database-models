...
const ParserBlockInfo_1 = require("./swapListener/ParserBlockInfo");
const SwapTokenEvent_1 = require("./swapListener/SwapTokenEvent");
    ...
    return __awaiter(this, void 0, void 0, function* () {
        const sequelize = new sequelize_typescript_1.Sequelize(dbLink, {
            ...
            models: [
                ...
                ParserBlockInfo_1.ParserBlockInfo,
                SwapTokenEvent_1.SwapTokenEvent,
            ]
        });
        if (sync)
...
__exportStar(require("./SkillFilter"), exports);
__exportStar(require("./swapListener/ParserBlockInfo"), exports);
__exportStar(require("./swapListener/SwapTokenEvent"), exports);
