...
const ProposalCreatedEvents_1 = require("./proposal/ProposalCreatedEvents");
const VoteCastEvents_1 = require("./proposal/VoteCastEvents");
const ProposalExecuted_1 = require("./proposal/ProposalExecuted");
    ...
    return __awaiter(this, void 0, void 0, function* () {
        const sequelize = new sequelize_typescript_1.Sequelize(dbLink, {
            ...
            models: [
                ...
                ProposalCreatedEvents_1.ProposalCreatedEvents,
                VoteCastEvents_1.VoteCastEvents,
                ProposalExecuted_1.ProposalExecuted,
...
__export(require("./proposal/ProposalCreatedEvents"));
__export(require("./proposal/VoteCastEvents"));
__export(require("./proposal/ProposalExecuted"));
