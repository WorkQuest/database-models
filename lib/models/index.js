...
const SavingsParseBlock_1 = require("./savings/SavingsParseBlock");
const SavingsBorrowedEvent_1 = require("./savings/SavingsBorrowedEvent");
const SavingsClaimedEvent_1 = require("./savings/SavingsClaimedEvent");
const SavingsReceivedEvent_1 = require("./savings/SavingsReceivedEvent");
const SavingsRefundedEvent_1 = require("./savings/SavingsRefundedEvent");
    ...
    return __awaiter(this, void 0, void 0, function* () {
        const sequelize = new sequelize_typescript_1.Sequelize(dbLink, {
            ...
            models: [
                ...
                SavingsParseBlock_1.SavingsParseBlock,
                SavingsBorrowedEvent_1.SavingsBorrowedEvent,
                SavingsClaimedEvent_1.SavingsClaimedEvent,
                SavingsReceivedEvent_1.SavingsReceivedEvent,
                SavingsRefundedEvent_1.SavingsRefundedEvent
            ]
        });
        if (sync)
...
__exportStar(require("./quest/QuestRaiseView"), exports);
...
__exportStar(require("./savings/SavingsParseBlock"), exports);
__exportStar(require("./savings/SavingsBorrowedEvent"), exports);
__exportStar(require("./savings/SavingsRefundedEvent"), exports);
__exportStar(require("./savings/SavingsReceivedEvent"), exports);
__exportStar(require("./savings/SavingsClaimedEvent"), exports);
