...
const UserBlockReason_1 = require("./user/UserBlockReason");
...
const QuestBlockReason_1 = require("./quest/QuestBlockReason");
const ChangeRole_1 = require("./user/ChangeRole");
    ...
    return __awaiter(this, void 0, void 0, function* () {
        const sequelize = new sequelize_typescript_1.Sequelize(dbLink, {
            ...
            models: [
                ...
                Quest_1.Quest,
                QuestBlockReason_1.QuestBlockReason,
...
__export(require("./user/UserBlockReason"));
__export(require("./QuestsStatistic"));
__export(require("./Language"));
__export(require("./quest/QuestBlockReason"));
__export(require("./user/ChangeRole"));
