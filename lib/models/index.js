...
const BorrowingParseBlock_1 = require("./borrowing/BorrowingParseBlock");
const Borrowing_1 = require("./borrowing/Borrowing");
const BorrowingBorrowedEvent_1 = require("./borrowing/BorrowingBorrowedEvent");
const BorrowingRefundedEvent_1 = require("./borrowing/BorrowingRefundedEvent");
    ...
    return __awaiter(this, void 0, void 0, function* () {
        const sequelize = new sequelize_typescript_1.Sequelize(dbLink, {
            ...
            models: [
                ...
                Borrowing_1.Borrowing,
                BorrowingParseBlock_1.BorrowingParseBlock,
                BorrowingBorrowedEvent_1.BorrowingBorrowedEvent,
                BorrowingRefundedEvent_1.BorrowingRefundedEvent,
            ]
        });
        if (sync)
...
__exportStar(require("./borrowing/types"), exports);
...
__exportStar(require("./borrowing/Borrowing"), exports);
__exportStar(require("./borrowing/BorrowingBorrowedEvent"), exports);
__exportStar(require("./borrowing/BorrowingRefundedEvent"), exports);
__exportStar(require("./borrowing/BorrowingParseBlock"), exports);
