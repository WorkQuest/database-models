...
__decorate([
    sequelize_typescript_1.HasMany(() => News_1.News, { onDelete: 'cascade', hooks: true, foreignKey: "authorId" })
], User.prototype, "authorId", void 0);
__decorate([
    sequelize_typescript_1.HasMany(() => Comment_1.Comment, { onDelete: 'cascade', hooks: true })
