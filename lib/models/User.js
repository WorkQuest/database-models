...
__decorate([
    sequelize_typescript_1.HasMany(() => ForumPost_1.ForumPost, { onDelete: 'cascade', hooks: true, foreignKey: "authorId" })
], User.prototype, "authorId", void 0);
__decorate([
    sequelize_typescript_1.HasMany(() => ForumPostComment_1.ForumPostComment, { onDelete: 'cascade', hooks: true })
