...
exports.isActivatedSchema = Joi.boolean().example(true).label('IsActiveSchema');
...
exports.adminLanguagesSchema = Joi.array().items(language_1.languageTableSchema).default([]).label('AdminLanguagesSchema');
exports.adminIdParams = Joi.object({
    adminId: common_1.idSchema.required()
});
exports.adminPlaceSchema = Joi.object({
    country: exports.adminCountrySchema,
    city: exports.adminCitySchema,
}).label('AdminPlaceSchema');
exports.adminAdditionalInfoSchema = Joi.object({
...
exports.adminSchema = Joi.object({
    ...
    isActivated: exports.isActivatedSchema,
    additionalInfo: exports.adminAdditionalInfoSchema,
