...
exports.languageSchema = Joi.string().max(255).example(models_1.AdminLanguages.en).label('languageSchema');
exports.adminLanguageSchema = Joi.object({
...
exports.adminSchema = Joi.object({
    ...
    languages: exports.adminLanguageSchema,
