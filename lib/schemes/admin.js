...
exports.adminQuerySchema = exports.adminSchema = exports.isActiveSchema = exports.adminRoleSchema = exports.adminPasswordSchema = exports.adminPhoneSchema = exports.adminEmailSchema = exports.adminLastNameSchema = exports.adminFirstNameSchema = void 0;
...
exports.adminRoleSchema = Joi.number().valid(...models_1.AdminRoles).default(models_1.AdminRole.main).example(models_1.AdminRole.main).label('RoleSchema');
