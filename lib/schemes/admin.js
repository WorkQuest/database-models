...
exports.resolvedDisputesSchema = Joi.number().example(5).label('ResolvedDisputes');
...
exports.adminDisputesStatisticSchema = Joi.object({
    id: common_1.idSchema,
    adminId: common_1.idSchema,
    resolvedDisputes: exports.resolvedDisputesSchema,
