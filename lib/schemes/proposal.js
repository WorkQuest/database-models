...
exports.proposalDelegateUserHistorySchema = exports.proposalDelegateVotesChangedEventSchema = exports.proposalDelegateChangedEventSchema = exports.proposalDelegateVotesTypeSchema = exports.proposalDelegatorSchema = exports.proposalVoteCastEventQuerySchema = exports.proposalVoteCastEventSortSchema = exports.proposalQuerySchema = exports.proposalSortSchema = exports.proposalCreatedEventSchema = exports.proposalVoteCastEventSchema = exports.proposalSchema = exports.proposalStatusesSchema = exports.proposalCreatedEvenMinimumQuorumSchema = exports.proposalCreatedEvenVotingPeriodSchema = exports.proposalVoteCastSupportSchema = exports.proposalVoteCastVotesSchema = exports.proposalNonceIdSchema = exports.proposalStatusSchema = exports.proposalDescriptionSchema = exports.proposalTitleSchema = void 0;
...
exports.proposalDelegatorSchema = Joi.object({
    ...
    user: user_1.userShortForListSchema,
}).label('ProposalDelegator');
exports.proposalDelegateVotesTypeSchema = Joi.string().valid('delegate', 'undelegate').example('delegate');
...
exports.proposalDelegateVotesChangedEventSchema = Joi.object({
    ...
    delegated: common_1.coinAmountSchema,
    type: exports.proposalDelegateVotesTypeSchema,
    delegateTimestamp: common_1.timestampSchema,
