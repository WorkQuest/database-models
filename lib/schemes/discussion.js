...
exports.discussionCommentsSchema = exports.discussionsSchema = exports.discussionSchema = exports.discussionTextSchema = exports.discussionTitleSchema = exports.discussionCommentSchema = exports.discussionCommentTextSchema = void 0;
...
exports.discussionTextSchema = Joi.string().example('Hello World!').label('DiscussionText');
exports.discussionSchema = Joi.object({
    id: common_1.idSchema,
    authorId: common_1.idSchema,
    title: exports.discussionTitleSchema,
    text: exports.discussionTextSchema,
    amountLikes: common_1.countSchema,
