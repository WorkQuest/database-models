...
exports.questDisputeStatusSchema = Joi.number().max(255).valid(...Object.values(models_1.DisputeStatus)).default(models_1.DisputeStatus.pending).example(models_1.DisputeStatus.pending).label('DisputeStatus');
