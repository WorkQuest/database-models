...
exports.unreadCountChatsSchema = Joi.number().example(123).label('UnreadCountChats');
exports.chatsStatisticSchema = Joi.object({
    id: common_1.idSchema,
    userId: common_1.idSchema,
    adminId: common_1.idSchema,
    type: chat_1.chatMemberTypeSchema,
    unreadCountChats: exports.unreadCountChatsSchema,
}).label('ChatStatistic');
exports.questsStatisticSchema = Joi.object({
    completed: common_1.countSchema,
    opened: common_1.countSchema,
}).label('QuestsStatistic');
exports.userRatingStatusSchema = Joi.number().valid(...Object.values(models_1.RatingStatus)).example(models_1.RatingStatus.topRanked).label("UserStatisticRatingStatus");
