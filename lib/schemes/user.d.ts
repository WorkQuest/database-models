...
export declare const profileVisibilityStatusSchema: Joi.NumberSchema;
export declare const profileVisibilityNetworkSchema: Joi.NumberSchema;
export declare const profileVisibilitySettingsSchema: Joi.ObjectSchema<any>;
