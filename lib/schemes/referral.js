...
exports.referralProgramReferralShortScheme = Joi.object({
    ...
    userAffiliate: user_1.userShortSchema
}).label('ReferralProgramAffiliateShort');
exports.referralProgramReferralsShortScheme = Joi.array().items(exports.referralProgramReferralShortScheme).label('ReferralProgramAffiliatesShort');
exports.affiliateUserReferralsSchema = Joi.object({
    paidRewards: common_1.coinAmountSchema,
    referralId: common_1.idSchema,
    count: common_1.countSchema,
    affiliates: exports.referralProgramReferralsShortScheme
}).label('ReferralProgramAffiliateShort');
