...
exports.supportTicketSchema = exports.decisionSupportTicketSchema = exports.statusSupportTicketSchema = exports.descriptionSupportTicketSchema = exports.titleSupportTicketSchema = exports.numberSupportTicketSchema = void 0;
...
exports.decisionSupportTicketSchema = Joi.string().valid(...Object.values(models_1.TicketDecision)).example(models_1.TicketDecision.Pending).label("DecisionSupportTicket");
exports.supportTicketSchema = Joi.object({
    ...
    decision: exports.decisionSupportTicketSchema,
