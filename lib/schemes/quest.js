...
exports.questSchema = Joi.object({
    ...
    specializations: specialization_1.specializationsSchema,
...
exports.questsQuerySchema = Joi.object({
    ...
    employment: exports.questEmploymentSchema.default(null),
...
exports.questForGetSchema = Joi.object({
    ...
    medias: media_1.mediasUrlOnlySchema,
    questSpecializations: specialization_1.specializationsSchema,
    createdAt: common_1.isoDateSchema,
}).label('QuestForGet');
