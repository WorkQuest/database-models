...
exports.questWorkPlaceSchema = Joi.string().valid(...Object.keys(models_1.QuestWorkPlace).map(key => parseInt(key)).filter(key => !isNaN(key))).example(models_1.QuestWorkPlace.Distant).label('QuestWorkPlaceSchema');
