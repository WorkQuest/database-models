...
exports.questDisputeMessageTextSchema = Joi.string().example("Hello world!").label('QuestDisputeMessageText');
...
exports.questDisputeReviewSchema = Joi.object({
    ...
    message: exports.questDisputeMessageTextSchema,
