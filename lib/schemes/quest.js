...
exports.questDisputeDecisionSchema = Joi.number().valid(...Object.keys(models_1.DisputeDecision).map(key => parseInt(key)).filter(key => !isNaN(key))).example(models_1.DisputeDecision.AcceptWork).label('DisputeDecision');
