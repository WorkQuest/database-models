...
exports.questEmploymentsSchema = Joi.array().items(exports.questEmploymentSchema).label('QuestsResponses');
exports.questPrioritiesSchema = Joi.array().items(exports.questPrioritySchema).label('Quests');
exports.questsQuerySchema = Joi.object({
    ...
    workplace: exports.questWorkPlaceSchema.default(null),
