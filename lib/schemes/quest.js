...
exports.questWorkPlacementSchema = Joi.number().valid(...Object.keys(models_1.QuestWorkPlacement).map(key => parseInt(key)).filter(key => !isNaN(key))).example(models_1.QuestWorkPlacement.Distant).label('QuestWorkPlacementSchema');
exports.questSchema = Joi.object({
    ...
    placement: exports.questWorkPlacementSchema,
