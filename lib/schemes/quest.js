...
exports.questDisputeStatusesSchema = exports.questDisputeReviewMessageTextSchema = exports.questDisputeReviewMarkSchema = exports.questDisputeDecisionSchema = exports.questDisputeDecisionDescriptionSchema = exports.questDisputeProblemDescriptionSchema = exports.questDisputeReasonSchema = exports.questDisputeStatusSchema = exports.questDisputeNumberSchema = exports.questBlackListSchema = exports.questBlackListStatusSchema = exports.questBlackListReasonSchema = exports.questForAdminsGetSchema = exports.questsForGetWithCountSchema = exports.questsForGetSchema = exports.questForGetSchema = exports.reviewsSchema = exports.questReviewSchema = exports.questReviewMarkSchema = exports.questReviewMessageSchema = exports.questsResponsesWithCountSchema = exports.questsResponsesSchema = exports.questsResponseSchema = exports.questsResponseTypeSchema = exports.questsResponseStatusSchema = exports.questsResponseMessageSchema = exports.questQueryForMapPointsSchema = exports.questQueryForGetWorkersSchema = exports.questQuerySchema = exports.questsPayloadSchema = exports.updatedBetweenSchema = exports.createdBetweenSchema = exports.betweenPriceSchema = exports.questsListSortSchema = exports.questsWithCountSchema = exports.questsSchema = exports.questSchema = exports.questNonceSchema = exports.questStatusesSchema = exports.questPrioritiesSchema = exports.questEmploymentsSchema = exports.questEmploymentSchema = exports.questLocationPlaceNameSchema = exports.questPriceSchema = exports.questDescriptionSchema = exports.questTitleSchema = exports.questStatusSchema = exports.questChatOnlyIdsSchema = exports.questChatSchema = exports.questChatStatusSchema = void 0;
exports.questDisputeReviewSchema = exports.questDisputesWithCountSchema = exports.questDisputesSchema = exports.questDisputeQuerySchema = exports.questDisputeWIthChatSchema = exports.questDisputeSchema = exports.questDisputeDecisionsSchema = void 0;
...
exports.questChatStatusSchema = Joi.number().valid(...Object.keys(models_1.QuestChatStatus).map(key => parseInt(key)).filter(key => !isNaN(key))).example(models_1.QuestChatStatus.Open).label('QuestChatStatus');
...
exports.questChatOnlyIdsSchema = Joi.object({
    employerId: common_1.idSchema,
    workerId: common_1.idSchema,
    questId: common_1.idSchema,
    responseId: common_1.idSchema,
...
exports.questSchema = Joi.object({
    ...
    typeOfEmployment: exports.questEmploymentSchema,
...
exports.questsListSortSchema = Joi.object({
    ...
    invitedCreatedAt: common_1.sortDirectionSchema,
    respondedCreatedAt: common_1.sortDirectionSchema,
...
exports.createdBetweenSchema = Joi.object({
    from: common_1.timestampSchema.required(),
    to: common_1.timestampSchema.required(),
}).label('CreatedBetween');
exports.updatedBetweenSchema = Joi.object({
    from: common_1.timestampSchema.required(),
    to: common_1.timestampSchema.required(),
...
exports.questQuerySchema = Joi.object({
    ...
    typeOfEmployments: exports.questEmploymentsSchema.unique().default(null),
...
exports.questDisputeDecisionSchema = Joi.string().valid(...Object.values(models_1.DisputeDecision)).example(models_1.DisputeDecision.AcceptWork).label("DisputeDecision");
...
exports.questDisputeDecisionsSchema = Joi.array().items(exports.questDisputeDecisionSchema).label('QuestDisputeDecisions');
exports.questDisputeSchema = Joi.object({
    ...
    decision: exports.questDisputeDecisionSchema,
...
exports.questDisputeWIthChatSchema = exports.questDisputeSchema.keys({
    quest: exports.questSchema.keys({
        questChat: exports.questChatOnlyIdsSchema
    }),
