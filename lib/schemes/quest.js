...
exports.questEmploymentSchema = Joi.number().valid(...Object.keys(models_1.QuestEmployment).map(key => parseInt(key)).filter(key => !isNaN(key))).example(models_1.QuestEmployment.FullTime).label('QuestEmploymentSchema');
