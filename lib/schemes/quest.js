...
exports.questDisputeLanguagesSchema = Joi.array().items(user_1.userLanguageSchema).label('QuestDisputeLanguages');
...
exports.questDisputeQuerySchema = Joi.object({
    ...
    offset: common_1.offsetSchema,
    q: common_1.searchSchema,
    languages: exports.questDisputeLanguagesSchema.unique().default(null),
