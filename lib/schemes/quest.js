...
exports.questWorkPlaceSchema = Joi.string().valid(...Object.values(models_1.QuestWorkPlace)).example(models_1.QuestWorkPlace.Distant).label('QuestWorkPlaceSchema');
