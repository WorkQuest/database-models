...
exports.shortFilterSchema = Joi.object({
    category: filterCategorySchema,
    skills: filterSkillSchema
}).label('ShortFilterSchema');
exports.shortFiltersSchema = Joi.array().items(exports.shortFilterSchema).label('ShortFiltersSchemaResponse');
exports.filtersSchema = Joi.array().items(exports.questFilterSchemaResponse).label('FiltersSchemaResponse');
exports.filtersUserSchema = Joi.array().items(exports.userFilterSchemaResponse).label('FiltersUserSchemaResponse');
