...
exports.chatIdsSchema = exports.chatsSchema = exports.chatSchema = exports.messageIdsSchema = exports.messagesSchema = exports.messageSchema = exports.messageTextSchema = exports.messageTypeSchema = exports.chatNameSchema = exports.chatTypeSchema = void 0;
...
exports.messageTypeSchema = Joi.number().valid(...Object.keys(models_1.MessageType).map(key => parseInt(key)).filter(key => !isNaN(key))).example(models_1.MessageType.common).label('MessageType');
