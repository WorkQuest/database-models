...
exports.chatMemberRoleSchema = Joi.string().valid(...Object.values(models_1.MemberRole)).example(models_1.MemberRole.User).label("ChatMemberRole");
...
exports.chatMemberSchema = Joi.object({
    ...
    role: exports.chatMemberRoleSchema,
