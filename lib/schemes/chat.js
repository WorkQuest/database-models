...
exports.removingFromChatReasonSchema = Joi.string().valid(...Object.values(models_1.ReasonForRemovingFromChat)).example(models_1.ReasonForRemovingFromChat).label("DeletionReason");
