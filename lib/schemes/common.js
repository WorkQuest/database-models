...
exports.mobilePhoneSchema = Joi.string().pattern(/^\+\d{1,4}\d{10}$/).example('+79998887766').label('MobilePhone');
exports.mobilePhoneWithoutCountryCodeSchema = Joi.string().pattern(/^\d{1,3}\d{10}$/).example('9998887766').label('MobilePhoneWithoutCountryCode');
