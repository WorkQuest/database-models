...
exports.prioritySchema = Joi.number().valid(...Object.keys(models_1.Priority).map(key => parseInt(key)).filter(key => !isNaN(key))).example(models_1.Priority.AllPriority).label('QuestPriority');
