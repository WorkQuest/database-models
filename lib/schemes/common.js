...
exports.percentSchema = Joi.number().example(45.5);
...
exports.workPlaceSchema = Joi.string().valid(...Object.values(models_1.WorkPlace)).example(models_1.WorkPlace.Remote).label('WorkPlace');
exports.workPlacesSchema = Joi.array().items(exports.workPlaceSchema).label('WorkPlaces');
exports.payPeriodSchema = Joi.string().valid(...Object.values(models_1.PayPeriod)).example(models_1.PayPeriod.FixedPeriod).label('PayPeriod');
exports.payPeriodsSchema = Joi.array().items(exports.payPeriodSchema).label('PayPeriods');
