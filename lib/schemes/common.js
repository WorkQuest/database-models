...
const types_1 = require("../models/user/types");
...
exports.userRaiseTypeSchema = Joi.number().valid(...Object.values(types_1.UserRaiseType)).example(types_1.UserRaiseType.GoldPlus).label('UserRaiseType');
