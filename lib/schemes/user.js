...
exports.userPhoneSchema = common_1.mobilePhoneSchema.label("UserPhone");
exports.userTempPhoneSchema = common_1.mobilePhoneSchema.label("UserTempPhone");
...
exports.userAdditionalInfoWorkerSchema = Joi.object({
    secondMobileNumber: common_1.mobilePhoneSchema.allow(null).label('SecondMobileNumber'),
