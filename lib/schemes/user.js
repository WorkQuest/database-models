...
exports.userDelegateWQTSchema = Joi.string().example("35474").label('UserDelegateWQT');
...
exports.userSchema = Joi.object({
    ...
    delegate: exports.userDelegateWQTSchema,
...
exports.workerQuerySchema = Joi.object({
    ...
    south: common_1.locationSchema,
    sort: exports.userListSortSchema,
    priority: common_1.prioritySchema.default(null),
    ratingStatus: ratingStatistic_1.ratingStatusSchema.default(null),
