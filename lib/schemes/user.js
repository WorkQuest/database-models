...
exports.userBlackReasonSchema = Joi.string().example('Reason...').label('UserBlackReason');
exports.userBlackStatusSchema = Joi.number().valid(...Object.keys(models_1.UserBlackListStatus).map(key => parseInt(key)).filter(key => !isNaN(key))).example(models_1.UserBlackListStatus.Blocked).label("UserBlackStatus");
exports.userBlackListSchema = Joi.object({
    id: common_1.idSchema,
    blockedByAdminId: common_1.idSchema,
    unblockedByAdminId: common_1.idSchema,
    userId: common_1.idSchema,
    reason: exports.userBlackReasonSchema,
    userStatusBeforeBlocking: exports.userStatusSchema,
    status: exports.userBlackStatusSchema,
