...
exports.userBlackListStatusSchema = Joi.number().valid(...Object.keys(models_1.UserBlackListStatus).map(key => parseInt(key)).filter(key => !isNaN(key))).example(models_1.UserBlackListStatus.Blocked).label("UserBlackStatus");
