...
exports.networkProfileVisibilitySchema = Joi.number().valid(...Object.keys(models_1.NetworkProfileVisibility).map(key => parseInt(key)).filter(key => !isNaN(key))).example(models_1.NetworkProfileVisibility.AllUsers).label("NetworkProfileVisibility");
