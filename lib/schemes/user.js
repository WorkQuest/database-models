...
exports.workerPrioritiesSchema = Joi.array().items(common_1.prioritySchema).label('WorkerPriorities');
exports.workerRatingStatusesSchema = Joi.array().items(statistics_2.ratingStatusSchema).label('WorkerRatingStatuses');
...
exports.userSchema = Joi.object({
    ...
    ratingStatistic: statistics_2.ratingStatisticSchema,
    questsStatistic: statistics_1.questsStatisticSchema,
    chatStatistic: statistics_3.chatsStatisticSchema,
...
exports.employerQuerySchema = Joi.object({
    ...
    ratingStatus: statistics_2.ratingStatusSchema.default(null),
}).label('UserQuery');
exports.workerQuerySchema = Joi.object({
    ...
    south: common_1.locationSchema,
    sort: exports.userListSortSchema,
    priority: exports.workerPrioritiesSchema.default(null),
    ratingStatus: exports.workerRatingStatusesSchema.default(null),
    workplace: common_1.workPlacesSchema.unique().default(null),
