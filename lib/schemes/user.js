...
exports.userLocationPlaceNameSchema = Joi.string().min(0).max(100).example("Tomsk").label("locationPlaceName");
...
exports.workerRatingStatusesSchema = Joi.array().items(statistics_3.ratingStatusSchema).label('WorkerRatingStatuses');
...
exports.userSchema = Joi.object({
    ...
    locationPlaceName: exports.userLocationPlaceNameSchema,
...
exports.employerQuerySchema = Joi.object({
    ...
    ratingStatus: statistics_3.ratingStatusSchema.default(null),
}).label('UserQuery');
exports.workerQuerySchema = Joi.object({
    ...
    locationPlaceName: exports.userLocationPlaceNameSchema.default(null),
