...
exports.blockReasonSchema = Joi.string().example('You was blocked').label('BlockReason');
exports.userBlockReasonSchema = Joi.object({
    id: common_1.idSchema,
    userId: common_1.idSchema,
    blockReason: exports.blockReasonSchema,
    previousStatus: exports.userStatusSchema,
    user: exports.userShortSchema,
