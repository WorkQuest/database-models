...
exports.ratingStatusesCanRespondToQuestSchema = Joi.array().items(exports.ratingStatusCanRespondToQuestSchema).label('RatingStatusesInMySearch');
...
exports.employerProfileVisibilitySettingsSchema = Joi.object({
    ratingStatusCanRespondToQuest: exports.ratingStatusesCanRespondToQuestSchema.allow(null).required(),
    ratingStatusInMySearch: exports.ratingStatusesInMySearchSchema.allow(null).required(),
