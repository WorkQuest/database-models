...
const ProfileVisibilitySetting_1 = require("../models/user/ProfileVisibilitySetting");
...
exports.networkProfileVisibilitySchema = Joi.number().valid(...Object.keys(ProfileVisibilitySetting_1.NetworkProfileVisibility).map(key => parseInt(key)).filter(key => !isNaN(key))).example(ProfileVisibilitySetting_1.NetworkProfileVisibility.EveryoneOnTheInternet).label("NetworkProfileVisibility");
exports.jobPriorityProfileVisibilitySchema = Joi.number().valid(...Object.keys(models_1.Priority).map(key => parseInt(key)).filter(key => !isNaN(key))).example(models_1.Priority.AllPriority).label("JobPriorityProfileVisibility");
exports.profileVisibilitySchema = Joi.object({
    networkProfileVisibility: exports.networkProfileVisibilitySchema.allow(null).required(),
    jobPriorityProfileVisibility: exports.jobPriorityProfileVisibilitySchema.allow(null).required(),
