...
exports.userBlackListSchema = exports.userBlackListStatusSchema = exports.userBlackListReasonSchema = exports.userSessionsSchema = exports.userSessionSchema = exports.profileVisibilitySettingsSchema = exports.profileVisibilityNetworkSchema = exports.profileVisibilityStatusSchema = exports.tokensWithStatus = exports.usersShortWithAdditionalInfoSchema = exports.usersShortSchema = exports.userWorkersSchema = exports.userEmployersSchema = exports.usersSchema = exports.workerPayloadSchema = exports.workerQueryForMapPointsSchema = exports.workerQuerySchema = exports.employerQuerySchema = exports.betweenCostPerHourSchema = exports.userListSortSchema = exports.userShortWithWalletSchema = exports.userShortWithAdditionalInfoSchema = exports.userShortSchema = exports.userWorkerSchema = exports.userEmployerSchema = exports.userMeSchema = exports.userSchema = exports.userCommonAdditionalInfoSchema = exports.userAdditionalInfoEmployerSchema = exports.userAdditionalInfoWorkerSchema = exports.userWorkExperienceSchema = exports.userKnowledgeSchema = exports.userSocialMediaNicknamesSchema = exports.workerCostPerHourSchema = exports.userRoleSchema = exports.userStatusKycSchema = exports.userStatusSchema = exports.userTotpIsActiveSchema = exports.userLastNameSchema = exports.userFirstNameSchema = exports.userPasswordSchema = exports.userEmailSchema = void 0;
...
exports.workerQuerySchema = Joi.object({
    ...
    payPeriods: common_1.payPeriodsSchema,
    northAndSouthCoordinates: common_1.searchByNorthAndSouthCoordinatesSchema.default(null),
}).label('WorkerQuery');
...
exports.profileVisibilityStatusSchema = Joi.number().valid(...Object.keys(models_1.RatingStatus).map(key => parseInt(key)).filter(key => !isNaN(key))).example(models_1.Priority.AllPriority).label("ProfileVisibilityStatus");
exports.profileVisibilityNetworkSchema = Joi.number().valid(...Object.keys(models_1.NetworkProfileVisibility).map(key => parseInt(key)).filter(key => !isNaN(key))).example(models_1.NetworkProfileVisibility.AllUsers).label("ProfileVisibilityNetwork");
exports.profileVisibilitySettingsSchema = Joi.object({
    network: exports.profileVisibilityNetworkSchema.allow(null).required(),
    ratingStatus: exports.profileVisibilityStatusSchema.allow(null).required(),
