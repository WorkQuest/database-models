...
exports.statusProfileVisibilitySchema = Joi.number().valid(...Object.keys(models_1.RatingStatus).map(key => parseInt(key)).filter(key => !isNaN(key))).example(models_1.Priority.AllPriority).label("StatusProfileVisibility");
exports.profileVisibilitySchema = Joi.object({
    ...
    jobPriorityProfileVisibility: exports.statusProfileVisibilitySchema.allow(null).required(),
