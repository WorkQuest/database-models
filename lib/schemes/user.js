...
exports.workerProfileVisibilitySettingsSchema = Joi.object({
    ratingStatusCanInviteMeOnQuest: exports.ratingStatusCanInviteMeOnQuestSchema.required(),
    ratingStatusInMySearch: exports.ratingStatusInMySearchSchema.required(),
}).label('WorkerProfileVisibilitySettings');
exports.employerProfileVisibilitySettingsSchema = Joi.object({
    ratingStatusCanRespondToQuest: exports.ratingStatusCanRespondToQuestSchema.required(),
    ratingStatusInMySearch: exports.ratingStatusInMySearchSchema.required(),
