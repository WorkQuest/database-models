...
exports.userStatusKYCSchema = Joi.number().valid(...models_1.StatusesKYC).default(models_1.StatusKYC.Unconfirmed).example(models_1.StatusKYC.Unconfirmed).label('StatusKYCSchema');
