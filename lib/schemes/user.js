...
exports.userCountrySchema = Joi.string().max(255).example('Russia').label('UserCountrySchema');
exports.userCitySchema = Joi.string().max(255).example('Tomsk').label('UserCitySchema');
exports.userIpAddressSchema = Joi.string().max(255).example('192.168.1.1').label('UserIpAddressSchema');
exports.userStatusKYCSchema = Joi.number().valid(...Object.values(models_1.StatusKYC)).default(models_1.StatusKYC.Unconfirmed).example(models_1.StatusKYC.Unconfirmed).label('StatusKYCSchema');
exports.userDeviceSchema = Joi.string().max(255).example('Phone').label('UserDeviceSchema');
exports.userConfirmCodeSchema = Joi.string().max(255).example('2D4em7').label('UserConfirmCodeSchema');
exports.userSecretSchema = Joi.string().max(255).example('JAYWY6KYG47XYNQ5').label('UserSecuritySchema');
exports.userTOTPActiveSchema = Joi.boolean().example(false).label('UserTOTPActiveSchema');
exports.userSessionIsActiveSchema = Joi.bool().example(false).label('UserSessionIsActiveSchema');
exports.userBlockReasonSchema = Joi.string().example('You are blocked').label('UserBlockReasonSchema');
exports.userTOTPSchema = Joi.object({
    confirmCode: exports.userConfirmCodeSchema,
    active: exports.userTOTPActiveSchema,
    secret: exports.userSecretSchema,
}).label('UserTOTPSchema');
exports.userSecuritySchema = Joi.object({
    TOTP: exports.userTOTPSchema,
}).label('UserSecuritySchema');
exports.userSocialInfoSchema = Joi.object({
    id: common_1.idSchema,
    email: exports.userEmailSchema,
    last_name: exports.userLastNameSchema,
    first_name: exports.userFirstNameSchema,
}).label('UserSocialInfoSchema');
exports.userSocialSchema = Joi.object({
    google: exports.userSocialInfoSchema,
    facebook: exports.userSocialInfoSchema,
    twitter: exports.userSocialInfoSchema,
    linkedin: exports.userSocialInfoSchema,
}).label('UserSocialSchema');
exports.userSettingsSchema = Joi.object({
    restorePassword: exports.userConfirmCodeSchema,
    emailConfirm: exports.userConfirmCodeSchema,
    phoneConfirm: exports.userConfirmCodeSchema,
    social: exports.userSocialSchema,
    security: exports.userSecuritySchema
}).label('UserSettingsSchema');
exports.userPlaceSchema = Joi.object({
    country: exports.userCountrySchema,
    city: exports.userCitySchema,
...
exports.userLastSessionSchema = Joi.object({
    ...
    ipAddress: exports.userIpAddressSchema,
    isActive: exports.userSessionIsActiveSchema,
...
exports.userBlockSchema = Joi.object({
    id: common_1.idSchema,
    userId: common_1.idSchema,
    blockReason: exports.userBlockReasonSchema,
    previousStatus: exports.userStatusSchema,
...
exports.userSchema = Joi.object({
    ...
    userBlockReason: exports.userBlockSchema,
    lastSession: exports.userLastSessionSchema,
    createdAt: common_1.isoDateSchema,
    updatedAt: common_1.isoDateSchema,
}).label("UserSchema");
exports.userFullSchema = Joi.object({
    ...
    statusKYC: exports.userStatusKYCSchema,
    avatar: media_1.mediaUrlOnlySchema.allow(null),
    reviews: review_1.reviewsSchema,
    ratingStatistic: ratingStatistic_1.ratingStatisticSchema,
    questsStatistic: questsStatistic_1.questsStatisticSchema,
    ...
    logoutAt: common_1.isoDateSchema,
    changeRoleAt: common_1.isoDateSchema,
    createdAt: common_1.isoDateSchema,
    updatedAt: common_1.isoDateSchema,
    deletedAt: common_1.isoDateSchema,
}).label("UserFullSchema");
exports.userWithSettingsFullSchema = Joi.object({
    id: common_1.idSchema.label("UserId"),
    avatarId: common_1.idSchema.label('AvatarId'),
    lastSessionId: common_1.idSchema,
    firstName: exports.userFirstNameSchema,
...
exports.userIdsSchema = Joi.array().items(userIdSchema).label('UserIds');
