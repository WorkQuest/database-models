...
exports.ratingStatusesCanRespondOnQuestSchema = Joi.array().items(exports.ratingStatusCanRespondOnQuestSchema).label('RatingStatusesInMySearch');
...
exports.ratingStatusesInMySearchSchema = Joi.array().items(exports.ratingStatusInMySearchSchema).label('RatingStatusesCanRespondOnQuest');
exports.workerProfileVisibilitySettingsSchema = Joi.object({
    ratingStatusCanInviteMeOnQuest: exports.ratingStatusesCanInviteMeOnQuestSchema.allow(null).required(),
    ratingStatusInMySearch: exports.ratingStatusesInMySearchSchema.allow(null).required(),
}).label('WorkerProfileVisibilitySettings');
exports.employerProfileVisibilitySettingsSchema = Joi.object({
    ratingStatusCanRespondOnQuest: exports.ratingStatusesCanRespondOnQuestSchema.allow(null).required(),
    ratingStatusInMySearch: exports.ratingStatusesInMySearchSchema.allow(null).required(),
