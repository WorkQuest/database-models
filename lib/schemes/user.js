...
exports.userLanguageSchema = Joi.string().valid(...Object.values(models_1.UserLanguage)).example(models_1.UserLanguage.EN).label("UserLanguage");
...
exports.userSchema = Joi.object({
    ...
    language: exports.userLanguageSchema,
