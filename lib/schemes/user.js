...
exports.workerWageSchema = Joi.string().example("123").label('UserWageSchema');
...
exports.userWorkerSchema = Joi.object({
    ...
    wagePerHour: exports.workerWageSchema,
    role: exports.userRoleSchema,
    avatar: media_1.mediaUrlOnlySchema.allow(null),
    ratingStatistic: ratingStatistic_1.ratingStatisticSchema,
    userSpecializations: specialization_1.modelSpecializationsSchema,
...
exports.betweenWageSchema = Joi.object({
    from: exports.workerWageSchema.required(),
    to: exports.workerWageSchema.required(),
}).label('BetweenWage');
exports.userQuerySchema = Joi.object({
    ...
    wagePerHour: exports.betweenWageSchema
}).label('UserQuery');
