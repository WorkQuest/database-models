...
exports.workerProfileVisibilitySettingsSchema = Joi.object({
    ratingStatusCanInviteMeOnQuest: exports.ratingStatusesCanInviteMeOnQuestSchema.required(),
    ratingStatusInMySearch: exports.ratingStatusesInMySearchSchema.required(),
}).label('WorkerProfileVisibilitySettings');
exports.employerProfileVisibilitySettingsSchema = Joi.object({
    ratingStatusCanRespondToQuest: exports.ratingStatusesCanRespondToQuestSchema.required(),
    ratingStatusInMySearch: exports.ratingStatusesInMySearchSchema.required(),
