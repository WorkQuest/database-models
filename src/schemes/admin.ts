...
import { AminRole, AdminRoles } from "../models";
...
export const adminRoleSchema = Joi.string().max(255).valid(...AdminRoles).default(AminRole.main).example('main').label('RoleSchema');
