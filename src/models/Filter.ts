...
export class Filter extends Model {
    ...
    @ForeignKey(() => User) @Column({type: DataType.STRING, defaultValue:null}) userId: string;
    @ForeignKey(() => Quest) @Column({type: DataType.STRING, defaultValue:null}) questId: string;
